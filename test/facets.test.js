...
describe('facets:url', () => {
  it('url:bare', () => {
    ...
    assert.equal(facets.url({ url: 'https://www.example.com/user/2024013579' }), `https://www.example.com/user/${encodeURIComponent('<number>')}`);
    assert.equal(facets.url({ url: 'https://www.example.com/user/2025013579' }), `https://www.example.com/user/2025013579`);
